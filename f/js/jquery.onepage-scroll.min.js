  ...
  e.fn.onepage_scroll = function(n) {
    ...
    e.each(s, function(t) {
      ...
      if (r.direction == "horizontal") leftPos = leftPos + 100;
        ...
        paginationList += "<li><a data-index='" + (t + 1) + "' href='#" + (t + 1) + "'></a> <span class='asd'>"+ e(r.sectionContainer + ".active").data("section-name") + "</span></li>"
      }
      console.log(e(r.sectionContainer + ".active").data("section-name"));
    });
    i.swipeEvents().bind("swipeDown", function(t) {
      if (!e("body").hasClass("disabled-onepage-scroll")) t.preventDefault();
      i.moveUp()
